...
{
	[Package("laima")]
	[SkillHandler(SkillId.Escrimeur_GrandFente)]
	public class Escrimeur_GrandFente : IGroundSkillHandler
	{
		...
		{
			await EskrimerSkillHelper.AttackForward(caster, skill, originPos, farPos, 130, 36, 220, 80);
		}
	}
}
