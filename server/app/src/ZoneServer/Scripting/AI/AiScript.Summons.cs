...
namespace GuiltineSin.Zone.Scripting.AI
{
	...
	public abstract partial class AiScript
	{
		...
		protected void CheckEnemiesSummon()
		{
			...
			if (this.Entity is Summon summon && summon.Vars.GetBool("GuiltineSin.Necromancer.ManualOrderOnly", false) && mostHated == null)
				return;
		...
		protected void CheckEnemiesEnhanced()
		{
			...
			if (this.Entity is Summon summon && summon.Vars.GetBool("GuiltineSin.Necromancer.ManualOrderOnly", false))
			{
