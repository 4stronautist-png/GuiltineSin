...
{
    /// <summary>
    /// Handler for the NakMuay skill Te Trong.
    /// </summary>
    [SkillHandler(SkillId.NakMuay_TeTrong)]
    public class NakMuay_TeTrong : IGroundSkillHandler
    {
        /// <summary>
        ...
        private async Task Attack(Skill skill, ICombatEntity caster, ISplashArea splashArea)
        {
            ...
            foreach (var target in targets.LimitBySDR(caster, skill))
            {
	            ...
	            // Apply some debuff, e.g., stun or similar
	            target.StartBuff(BuffId.Stun, 0, 0, TimeSpan.FromMilliseconds(1000), caster);
