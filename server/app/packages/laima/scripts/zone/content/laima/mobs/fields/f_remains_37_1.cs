...
public class FRemains371MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_remains_37_1.Id1", MonsterId.Rootcrystal_04, min: 38, max: 50, respawn: Minutes(1), tendency: TendencyType.Peaceful);
		...
		AddSpawner("f_remains_37_1.Id6", MonsterId.Wendigo_Magician, min: 19, max: 25, respawn: Seconds(35), tendency: TendencyType.Aggressive);
		AddSpawner("f_remains_37_1.Id7", MonsterId.Templeslave_Sword, min: 30, max: 40, respawn: Seconds(35), tendency: TendencyType.Aggressive);
