...
public class CHighlanderMobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddPropertyOverrides("c_highlander", MonsterId.Wood_Carving_Fire, Properties("MHP", 999999999, "MINPATK", 0, "MAXPATK", 0, "MINMATK", 0, "MAXMATK", 0, "DEF", 999999, "MDEF", 999999));
		AddPropertyOverrides("c_highlander", MonsterId.Wood_Carving_Poison, Properties("MHP", 999999999, "MINPATK", 0, "MAXPATK", 0, "MINMATK", 0, "MAXMATK", 0, "DEF", 999999, "MDEF", 999999));
		AddPropertyOverrides("c_highlander", MonsterId.Wood_Carving_Lightning, Properties("MHP", 999999999, "MINPATK", 0, "MAXPATK", 0, "MINMATK", 0, "MAXMATK", 0, "DEF", 999999, "MDEF", 999999));
		AddPropertyOverrides("c_highlander", MonsterId.Wood_Carving_Earth, Properties("MHP", 999999999, "MINPATK", 0, "MAXPATK", 0, "MINMATK", 0, "MAXMATK", 0, "DEF", 999999, "MDEF", 999999));
