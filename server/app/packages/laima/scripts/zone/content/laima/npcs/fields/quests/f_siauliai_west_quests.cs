...
public class FSiauliaiWestQuestNpcsScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddNpc(20117, L("[Lost Farmer] Bronius"), "f_siauliai_west", -1895, -1007, 45, async dialog =>
		{
			...
			var questId = new QuestId("f_siauliai_west", 60001);
		...
		{
			var character = dialog.Player;
			var questId = new QuestId("f_siauliai_west", 60002);
		...
		{
			var character = dialog.Player;
			var questId = new QuestId("f_siauliai_west", 60003);
		...
		{
			var character = dialog.Player;
			var questId = new QuestId("f_siauliai_west", 60004);
		...
		{
			var character = dialog.Player;
			var questId = new QuestId("f_siauliai_west", 60005);
