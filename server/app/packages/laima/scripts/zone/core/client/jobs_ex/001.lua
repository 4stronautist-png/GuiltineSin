GuiltineSin.Override("UI_LIB_TAB_ADD_TAB_LIST", function(original, parent, tab, addTabInfoList, width, height, uiHorizontal, uiVertical, x, y, groupBoxKey, groupBoxValue, tabWidth, tabItemKeyName)
