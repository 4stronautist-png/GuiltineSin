GuiltineSin.Override("QUEST_UPDATE_ALL", function(original, frame)
	-- do nothing
end)

GuiltineSin.Override("QUESTINFOSET_2_QUEST_ANGLE", function(original, frame, msg, argStr, argNum)
...
GuiltineSin.Override("CHASEINFO_CLOSE_FRAME", function(original)
...
GuiltineSin.Override("QUEST_TAB_CHANGE", function(original, frame, argStr, argNum)
...
GuiltineSin.Override("QUEST_FILTER_UPDATE", function(original, frame, control, argStr, argNum)
	AUTO_CAST(control)
