...
public class FFarm492MobScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddSpawner("f_farm_49_2.Id2", MonsterId.Cyst, min: 22, max: 29, respawn: Seconds(25), tendency: TendencyType.Aggressive);
		AddSpawner("f_farm_49_2.Id3", MonsterId.Flying_Flog_Green, min: 8, max: 10, respawn: Seconds(25), tendency: TendencyType.Aggressive);
		AddSpawner("f_farm_49_2.Id4", MonsterId.Flying_Flog_Green, min: 60, max: 80, respawn: Seconds(25), tendency: TendencyType.Aggressive);
		AddSpawner("f_farm_49_2.Id5", MonsterId.Rootcrystal_01, min: 9, max: 12, respawn: Seconds(5), tendency: TendencyType.Peaceful);
		AddSpawner("f_farm_49_2.Id6", MonsterId.Pendinmire_Paviesa, amount: 1, respawn: Minutes(30), tendency: TendencyType.Peaceful);
