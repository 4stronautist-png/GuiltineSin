...
public class GuildColony_f_remains_37_1WarpsScript : GeneralScript
{
	protected override void Load()
	{
		...
		AddWarp("REMAINS37_1_REMAINS37", 48, From("GuildColony_f_remains_37_1", 2123.194, -745.3977), To("f_remains_37", -84, 2684));

		// Nuoridin Falls to Namu Temple Ruins
		AddWarp("REMAINS37_1_REMAINS37_2", 14, From("GuildColony_f_remains_37_1", -2785.502, 1350.796), To("f_remains_37_2", 1834, -391));
	}
}
